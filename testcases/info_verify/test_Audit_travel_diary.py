...
class Test_Audit_travel_diary(object):
    ...
    # 取消驴友日记发布审核数据
    def test_del_cancel_travel_diary(self):
        """
        这是驴友日记删除取消操作用例
        :return:
        """
    ...
    # 删除驴友日记审核数据
    def test_del_suc_travel_diary(self):
        """
    ...
    def test_Audit_travel_diary(self):
        '''
        这里是驴友日记审核
        :return:
        '''
...
if __name__ == '__main__':
    pytest.main('-vs', '[test_Audit_Trave_diary.py]', '--reruns=2')
