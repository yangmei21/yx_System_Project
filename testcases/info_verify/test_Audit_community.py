...
class TestAuditcommunity(object):
    ...
    # 取消删除社群发布审核数据
    def test_del_cancel_community(self):
        """
        这是社群发布删除取消操作用例
        :return:
        """
    ...
    # 删除社群发布审核数据
    def test_del_suc_community(self):
        """
    ...
    def test_search_community_not_exist(self):
        '''
        这里是查询社群发布信息审核列表--不存在
        :return:
        '''
...
if __name__ == '__main__':
    pytest.main('-vs', '[test_Aduit_community.py]', '--reruns=2')
